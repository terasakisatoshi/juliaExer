...
class TFModel:
    ...
    def prepare_model(self, checkpoint):
        ...
        self.interpreter = tf.contrib.lite.Interpreter(model_path=checkpoint)
    ...
    def __call__(self, img):
        ...
        """
        input_image = cv2.resize(img, (self.width, self.height))
...
def create_canvas(labels, top_k, prediction, display_size, elapsed):
    canvas = Image.new("RGB", (2 * display_size[1] // 3, display_size[1]), (0, 0, 0))
