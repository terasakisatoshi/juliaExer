...
vgg16() = Chain(
  ...
  Conv((3, 3), 64 => 64, relu, pad=(1, 1), stride=2),
  Conv((3, 3), 64 => 128, relu, pad=(1, 1), stride=(1, 1)),
  Conv((3, 3), 128 => 128, relu, pad=(1, 1), stride=2),
  Conv((3, 3), 128 => 256, relu, pad=(1, 1), stride=(1, 1)),
  Conv((3, 3), 256 => 256, relu, pad=(1, 1), stride=2),
  Conv((3, 3), 256 => 256, relu, pad=(1, 1), stride=(1, 1)),
  Conv((3, 3), 256 => 512, relu, pad=(1, 1), stride=2),
  x -> maxpool(x, (2, 2)),
